...
/usr/bin/nsenter -a -t 1 chmod +x /var/tmp/install/install.sh
/usr/bin/nsenter -a -t 1 chmod +x /var/tmp/install/wait.sh

echo "Executing wait script for the node to become ready for script execution"
/usr/bin/nsenter -a -t 1 /var/tmp/install/wait.sh

echo "Executing script"
/usr/bin/nsenter -a -t 1 /var/tmp/install/install.sh
